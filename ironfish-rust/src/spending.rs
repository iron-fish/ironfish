...
impl SpendProof {
    ...
    /// Converts the values to appropriate inputs for verifying the bellman proof confirms
    /// the randomized_public_key, commitment_value, anchor (root hash), and nullifier attached to
    /// this SpendProof.
