...
fn test_sign_zondax() {
    ...
    let mut unsigned_transaction = UnsignedTransaction::read(&unsigned_transaction_bytes[..])
    ...
    let seed_bytes: [u8; 80] = hex_to_bytes("abddfeea2f28d1d6a39d87cc7e43370b052d2738eb9d4cb01b360dda07945e13a6494273ad6b7085805e8fc94c23276e46f5442144c3803f92bb1efb5059ee615861d7a387f14a1ae591834aa28d19a8").unwrap();

    let mut rng = ZRng::from_bytes(seed_bytes);
    ...
    let signed_transaction = unsigned_transaction
        ...
        .expect("should be able to add signature to transaction");
    // verify transaction
    verify_transaction(&signed_transaction).expect("should be able to verify transaction");
}
