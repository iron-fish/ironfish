...
describe('ChainportMemoMetadata', () => {
  ...
  test('encodeCharaterTo6Bits encodes character to 6 bits', () => {
    expect(ChainportMemoMetadata.encodeCharaterTo6Bits('a')).toBe('001010')
    expect(ChainportMemoMetadata.encodeCharaterTo6Bits('1')).toBe('000001')
  })
  ...
  test('encode encodes networkId, address and to_ironfish flag correctly', () => {
    expect(
      ChainportMemoMetadata.encode(2, '5DF170F118753CaE92aaC2868A2C25Ccb6528f9a', false),
    ).toBe('000214d3c11c03c10481c50cc28e24228a30220620a08c08530c2c614220f24a')

    expect(
      ChainportMemoMetadata.encode(22, '7A68B1Cf1F16Ef89A566F5606C01BA49F4Eb420A', true),
