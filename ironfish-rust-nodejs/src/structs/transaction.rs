...
#[napi]
pub const TRANSACTION_SIGNATURE_LENGTH: usize = TRANSACTION_SIGNATURE_SIZE;

#[napi]
pub const TRANSACTION_PUBLIC_KEY_RANDOMNESS_LENGTH: usize = TRANSACTION_PUBLIC_KEY_SIZE;

#[napi]
pub const TRANSACTION_EXPIRATION_LENGTH: usize = TRANSACTION_EXPIRATION_SIZE;

#[napi]
pub const TRANSACTION_FEE_LENGTH: usize = TRANSACTION_FEE_SIZE;
