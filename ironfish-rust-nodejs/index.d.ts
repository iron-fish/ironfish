...
export function encrypt(passphrase: string, plaintext: string): EncryptResult
export function decrypt(passphrase: string, saltHex: string, nonceHex: string, ciphertextHex: string): string | null
