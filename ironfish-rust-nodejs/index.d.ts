...
export function createSigningCommitment(keyPackage: string, transactionHash: Buffer, signers: Array<string>): string
export function createSignatureShare(identity: string, keyPackage: string, signingPackage: string, transactionHash: Buffer, publicKeyRandomness: string, signers: Array<string>): string
