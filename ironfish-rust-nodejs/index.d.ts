...
export function createSigningCommitment(secretBytes: Buffer, identity: string, keyPackage: string, transactionHash: Buffer, signers: Array<string>): SignedCommitment
