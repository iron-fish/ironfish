...
const { KEY_LENGTH, NONCE_LENGTH, BoxKeyPair, randomBytes, boxMessage, unboxMessage, RollingFilter, ENCRYPTED_NOTE_LENGTH, OutputDescription, DECRYPTED_NOTE_LENGTH, Note, TransactionPosted, Transaction, verifyTransactions, generateKey, generateNewPublicAddress, initializeSapling, FoundBlockResult, ThreadPoolHandler, isValidPublicAddress } = nativeBinding
...
module.exports.OutputDescription = OutputDescription
