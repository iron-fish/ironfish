...
const { NoteEncrypted, Note, TransactionPosted, Transaction, TransactionType, generateKey, generateNewPublicAddress, initializeSapling, FoundBlockResult, ThreadPoolHandler } = nativeBinding
