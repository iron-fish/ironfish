...
const { KEY_LENGTH, NONCE_LENGTH, BoxKeyPair, randomBytes, boxMessage, unboxMessage, RollingFilter, AssetInfo, CreateAssetNote, MintAssetNote, NoteEncrypted, Note, TransactionPosted, Transaction, verifyTransactions, generateKey, generateNewPublicAddress, initializeSapling, FoundBlockResult, ThreadPoolHandler, isValidPublicAddress } = nativeBinding
...
module.exports.AssetInfo = AssetInfo
module.exports.CreateAssetNote = CreateAssetNote
module.exports.MintAssetNote = MintAssetNote
