...
export type DkgRoundOneRequest = {
}

export type DkgRoundOneResponse = {
}

export const DkgRoundOneRequestSchema: yup.ObjectSchema<DkgRoundOneRequest> =
  yup
    .object({
...
export const DkgRoundOneResponseSchema: yup.ObjectSchema<DkgRoundOneResponse> =
  yup
    .object({
