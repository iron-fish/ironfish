...
describe('IronfishTcpClient', () => {
  ...
  it('should handle message responses', async () => {
    ...
    // @ts-ignore
    const spyOnMessage = jest.spyOn(client, 'onMessage')
  ...
  it('should handle stream responses', async () => {
    ...
    // @ts-ignore
    const spyOnStream = jest.spyOn(client, 'onStream')
  ...
  it('should handle errors', async () => {
    ...
    // @ts-ignore
    const spyOnError = jest.spyOn(client, 'onError')
  ...
  it('should handle responses from malformed requests', async () => {
    ...
    // @ts-ignore
    await client.onData(
      Buffer.from(JSON.stringify({ type: 'malformedRequest', data: {} }), 'utf-8'),
    )
