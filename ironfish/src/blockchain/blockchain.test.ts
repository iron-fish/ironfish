...
describe('Blockchain', () => {
  ...
  describe('MerkleTrees', () => {
    it('should add notes and nullifiers to trees', async () => {
      ...
      expect(minersFeeA1.notes()).toHaveLength(1)
      expect(minersFeeA2.notes()).toHaveLength(1)
      expect(minersFeeB1.notes()).toHaveLength(1)
      expect(minersFeeB2.notes()).toHaveLength(1)
      expect(minersFeeB3.notes()).toHaveLength(1)
      expect(txA2.notes()).toHaveLength(2)
      expect(txA2.spends()).toHaveLength(1)
      expect(txB3.notes()).toHaveLength(2)
      expect(txB3.spends()).toHaveLength(1)
