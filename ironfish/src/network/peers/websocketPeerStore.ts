...
/**
 * PeerStoreManager stores the necessary data for connecting to new peers
 * and provides functionality for persistence of said data.
 */
export class WebsocketPeerStore {
  peerStore: PeerStore
  peerManager: PeerManager
  private peerIdentityMap: Map<Identity, PeerAddress>

  constructor(peerStore: PeerStore, peerManager: PeerManager) {
